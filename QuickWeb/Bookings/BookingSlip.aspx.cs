    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
              ...
              //  string BookingPrefix = Request.QueryString["BookingPrefix"].ToString();   
    ...
    public string GetBookingDetailsForBookingNumber(string BookNumber, string date, bool isComparing = false)
    {
        try
        {
            ...
            if (date == null)
            {
                ...
                dsBookingPrefix = BAL.BALFactory.Instance.BAL_ChallanIn.GetBookingNoAndPrefix(dsMain.Tables[0].Rows[0]["BookingNumber"].ToString());
                ...
                cmdDate.CommandText = "SELECT convert(varchar, BookingDeliveryDate, 106) from EntBookings where BookingNumber = " + strNewBookingNo + " AND BookingPrefix ='"+ strNewBookingPrefix+"' AND BranchId = " + Globals.BranchID + "";
        ...
        START:
            ...
            if (previousDue)
            {
                ...
                strPreview2 += "<tr><td>Total Amount Due :" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr>";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (PrintSubItems)
                            {
                                ...
                                strPreview += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                            else
                            {
                                if (StoreCopy)
