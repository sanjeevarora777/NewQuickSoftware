    ...
    public partial class InvoiceStatementSlip : System.Web.UI.Page
    {
        ...
        public string GetBookingDetailsForBookingNumber(string CustCode, string fromDate, string Todate)
        {
            ...
            START:
                ...
                if (prePrintedOrBanner)
                {
                    strPreview += "<tr style='font-size:12px'><td colspan='4' align='center'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;'><tr><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>M/s :&nbsp;" + dsInvoiceStatement.Tables[0].Rows[0]["CustomerName"].ToString() + "</td><td style='width:2.0in;' align='right'><table><tr><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>Total Qty :</td><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>" + totalItem + "</td></tr></table></td><td align='center' style='width: 4.0in'><table><tr><td style='font-weight: bold; font-size: 12px'>From Date :&nbsp;</td><td style='font-size: 12px'>" + fromDate + "</td><td style='font-weight: bold; font-size: 12px'>To :&nbsp;</td><td style='font-size: 12px'>" + Todate + "</td></tr></table></td><td align='center' style='width:4.0in' ><table><tr><td style='font-weight:bold;font-size:12px'>Bill Date :&nbsp;</td><td style='font-size:12px'> " + Convert.ToDateTime(DateTime.Today.ToString("dd MMM yyyy")).DayOfWeek.ToString() + " / " + DateTime.Today.ToString("dd MMM yyyy") + "</td></tr></table></td></tr></table></td></tr>";
                    strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width: 7.9in;'><tr><td style='width:0.5in;font-weight: bold;font-size:14px'>S.No</td><td style='width:0.5in;font-weight: bold;font-size:14px'></td><td style='width:5.0in;font-weight: bold;font-size:14px' align='left'>Particular's</td><td style='width:1.0in;font-weight: bold;font-size:14px' align='center'>Qty</td><td style='width:1.0in;font-weight: bold;font-size:14px' align='right'>Amount</td></tr>";
                }
                else
                {
                    strPreview += "<tr style='font-size:12px'><td colspan='4' align='center'><table style='width: 7.9in; border: thin solid #000000;'><tr><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>M/s :&nbsp;" + dsInvoiceStatement.Tables[0].Rows[0]["CustomerName"].ToString() + "</td><td style='width:2.0in;' align='right'><table><tr><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>Total Qty :</td><td style='font-weight:bold;font-size:12px' nowrap='nowrap'>" + totalItem + "</td></tr></table></td><td align='center' style='width: 4.0in'><table><tr><td style='font-weight: bold; font-size: 12px'>From Date :&nbsp;</td><td style='font-size: 12px'>" + fromDate + "</td><td style='font-weight: bold; font-size: 12px'>To :&nbsp;</td><td style='font-size: 12px'>" + Todate + "</td></tr></table></td><td align='center' style='width:4.0in' ><table><tr><td style='font-weight:bold;font-size:12px'>Bill Date :&nbsp;</td><td style='font-size:12px'> " + Convert.ToDateTime(DateTime.Today.ToString("dd MMM yyyy")).DayOfWeek.ToString() + " / " + DateTime.Today.ToString("dd MMM yyyy") + "</td></tr></table></td></tr></table></td></tr>";
                    strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width: 7.9in; border: thin solid #000000;'><tr><td style='width:0.5in;font-weight: bold;font-size:14px'>S.No</td><td style='width:0.5in;font-weight: bold;font-size:14px'></td><td style='width:5.0in;font-weight: bold;font-size:14px' align='left'>Particular's</td><td style='width:1.0in;font-weight: bold;font-size:14px' align='center'>Qty</td><td style='width:1.0in;font-weight: bold;font-size:14px' align='right'>Amount</td></tr>";
                }
                int incRow = 1;
                ...
                {
                    strPreview += "<tr style='font-size:12px'><td >" + dsInvoiceStatement.Tables[0].Rows[i]["SNo"].ToString() + "</td><td ></td><td>" + "<bolder>" + dsInvoiceStatement.Tables[0].Rows[i]["Garment"].ToString() + "</td><td align='center'>" + dsInvoiceStatement.Tables[0].Rows[i]["Qty"].ToString() + "</td><td align='right'>" + dsInvoiceStatement.Tables[0].Rows[i]["Amount"].ToString() + "</td></tr>";
                    incRow++;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            strPreview += "<tr style='font-size:10px'><td colspan='3' style='font-weight: bold; border-top-style: solid; border-top-width: thin;border-top-color: #000000' align='center'>Tax Bifercation<span style='font-weight: bold; font-size: 10px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", SlipVat) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", SlipCess) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", SlipHCess) + " )</span></td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>Subtotal</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + string.Format("{0:0.00}", Math.Round(wholeAmt, 2)) + "</td></tr>";
                            if (St)
                            {
                                strPreview += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Tax</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(serviceTax, 2)) + "</td></tr>";
                            }
                            if (BAL.BALFactory.Instance.BAL_New_Bookings.DisplayNetAmountFlatOrFolat(Globals.BranchID) == "True")
                            {
                                strPreview += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Grand Total</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round((Convert.ToDouble(wholeAmt) + Convert.ToDouble(serviceTax)) - Convert.ToDouble(disWhole), 2)) + "</td></tr>";
                            }
                            else
                            {
                                strPreview += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Grand Total</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Convert.ToInt32(Math.Round((Convert.ToDouble(wholeAmt) + Convert.ToDouble(serviceTax)) - Convert.ToDouble(disWhole), 2))) + "</td></tr>";
                            }
                        }
