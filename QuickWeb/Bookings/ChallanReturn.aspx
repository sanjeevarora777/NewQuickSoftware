<%@ Page Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    EnableEventValidation="false" Inherits="ChallanReturn" Title="Untitled Page"
    CodeBehind="ChallanReturn.aspx.cs" ValidateRequest="false" %>
        ...
        $(document).ready(function () {
            ...
            $('a, #ctl00_btnF1, #ctl00_btnF4, #btnDelivery').click(function (e) {
                ...
                if (_allRowsCount > 1 && e.clientX != 0 && e.clientY != 0) {
                    ...
                    console.log(e.target);
                    jBeep();
                    return confirm("You have selected few cloths but not marked these READY or sent for further processing. If you leave this page these changes will go unsaved.Click Cancel to Go Back OR Click OK to Leave Anyway.");
                }
            });
    ...
    <fieldset class="Fieldset">
        <table width="100%">
            <tr>
                ...
                <td class="H1" style="font-weight: bolder">
                    <asp:Label ID="Label5" runat="server" Text=" Receive From WorkShop" ForeColor="#FF9933"></asp:Label>
                    <span class="" style="font-size: 12Px">Mark all cloths that are READY TO BE DELIVERED
                        or Send for FINISHING</span>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table>
            <tr valign="top">
                ...
                <td class="TDCaption">
                    <asp:Label runat="server" ID="lblChallan" Text="Challan No"></asp:Label>
                    <asp:DropDownList runat="server" ID="ddlChallanNumber" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="DdlChallanNumberSelectedIndexChanged" AppendDataBoundItems="true">
            ...
            <tr>
                ...
                <td align="right" class="challanMoveButtons" nowrap="nowrap">
                    <asp:Button ID="bntSendToSP" runat="server" Text="Send for Finishing" ToolTip="Receive from Workshop & Send for Further Processing"
                        OnClick="bntSendToSP_Click" ClientIDMode="Static" CssClass="disabledClass" />
                    ...
                    <asp:Button ID="btnPrint" runat="server" Text="Ready for Delivery & Print Sticker"
                        OnClick="btnPrint_Click" ToolTip="Receive from Workshop, Mark Ready to be Delivered & Generate Packing Stickers"
