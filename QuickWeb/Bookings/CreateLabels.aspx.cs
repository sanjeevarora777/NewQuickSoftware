...
public partial class CreateLabels : BasePage
{
    ...
    {
        Response.Redirect("CreateLabels.aspx");
    }
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        grdNewChallan.DataBind();
        DataSet ds = new DataSet();
        ds = BAL.BALFactory.Instance.BAL_Sticker.GetDataStickerScreen(txtInvoiceFrom.Text, Globals.BranchID, txtHolidayDate.Text, txtInvoiceUpto.Text);
        grdNewChallan.DataSource = ds;
        grdNewChallan.DataBind();
    }
}