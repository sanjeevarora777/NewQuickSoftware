...
public partial class NewChallan : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {           
            if (PrjClass.getAccessRightMoveAllButtons("SendToWorkShop", "mstReceiptConfig", Globals.BranchID) == true)
            {
    ...
    public void BindMultiFactory()
    {
        ...
        {
            drpMulti.Items.Insert(0, new ListItem("Select"));
        }
    ...
    private void BindRightGrid()
    {
        ...
        dsNew = BAL.BALFactory.Instance.BAL_ChallanIn.BindGridView(Globals.BranchID, drpProcess, txtHolidayDate, hdnCheckStatus, hdnInvoiceNo, hdnRowNo, true);
    ...
    protected void btnSaveRemoveChallan_Click(object sender, EventArgs e)
    {
        if (hdnRmvReason.Value != "")
        {
            ...
            {                
                ...
                string res = BAL.BALFactory.Instance.BAL_ChallanIn.SaveRemoveChallan(hdnRmvReasonData.Value, hdnRmvReason.Value, Globals.UserName, Globals.BranchID, "34","1");
                if (res == "Record Saved")
                {
