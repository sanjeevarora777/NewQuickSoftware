<%@ Page Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    Inherits="DayBook" Title="DayBook Report" CodeBehind="DayBook.aspx.cs" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="H1" style="font-weight: bolder">
                    <asp:Label ID="Label1" runat="server" Text="DrySoft " ForeColor="#FF9933"></asp:Label>Day
                    book
                </td>
            </tr>
            <tr>
                            ...
                            <td class="TDCaption" style="text-align: left">
                                ...
                                <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                                    <asp:GridView ID="grdReport" runat="server" Visible="False" AutoGenerateColumns="False"
                                        ShowFooter="True" EmptyDataText="No record found" CssClass="mGrid">
                                        <Columns>
                                            <asp:BoundField DataField="BookingDate" HeaderText="Date" />
                                            <asp:BoundField DataField="BookingNumber" HeaderText="Booking No." />
                                            <asp:BoundField DataField="DC" HeaderText="DC Charges" />
                                            <asp:BoundField DataField="WC" HeaderText="WC Charges" />
