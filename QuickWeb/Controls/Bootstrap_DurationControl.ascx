<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Bootstrap_DurationControl.ascx.cs"
    Inherits="QuickWeb.Controls.Bootstrap_DurationControl" %>
<div>
