<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DurationControl.ascx.cs"
    Inherits="QuickWeb.DurationControl" %>
...
<div>
    <table>
        <tr>
            ...
            &nbsp;&nbsp;
            <td>
                <asp:CheckBox ID="chkShowOnlyHome" runat="server" />&nbsp;&nbsp;
                <asp:Label ID="Label1" runat="server" Text="Show Home Delivery" AssociatedControlID="chkShowOnlyHome"></asp:Label>
            </td>
        </tr>
    </table>
</div>