...
public partial class Laser_BookingSlip : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        GetBookingDetailsForBookingNumberHideAmount(data[0], date);
                    }
                    else
                    {
                ...
                if ((url.Length > 0) && (!url.Contains("New_Booking/frm_New_Booking.aspx")))
                {
                    ...
                    (
                    () => { BAL.BALFactory.Instance.BAL_New_Bookings.InvoiceEventHistorySaveData(data[0].ToUpper().Trim(), tmpUserName, tmpBranchID, "Order open from  "+ strActionMsg, ScreenName.ScrReportName,14); }
                    );
                }
            }
        }
    ...
    public string GetBookingDetailsForBookingNumber(string BookNumber, string date, bool isComparing = false)
    {
        try
        {
            ...
            double pending = 0;
            bool StoreCopy = true, PrintTaxDetail = false, BookingTime = true;
            ...
            //pending = BAL.BALFactory.Instance.Bal_Report.ReturnCustomerPendingBalance(dsMain.Tables[0].Rows[0]["CustomerCode"].ToString(), Globals.BranchID);            
            ...
            double discount = 0, serviceTax = 0, serviceTot = 0;
            for (int i = 0; i < dsMain.Tables[1].Rows.Count; i++)
            {
        ...
        START:
            ...
            double Advance1 = 0, DeliveryDiscount = 0, Paid = 0;
            if (previousDue)
            {
                if (Convert.ToInt32(hdnId.Value) < 11)
                {
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < dsMain.Tables[8].Rows.Count; i++)
                            Paid += Convert.ToDouble(dsMain.Tables[8].Rows[i]["Payment"].ToString());
                        ...
                        {
                            balance = (((pending + totalWholeAmt) - Advance1 - Paid - DeliveryDiscount));
                        }
                        else
                        {
                            balance = Math.Ceiling(((pending + totalWholeAmt) - Advance1 - Paid - DeliveryDiscount));
                        }
                        bal = balance;
                ...
                if (DeliveryDiscount != 0)
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                        strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                        strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    }
                }
                else
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    ...
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                        strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    }
                }
                if (strPreview2.Contains("Total Amount Due"))
                { }
                else
                {
                    strPreview2 += "<tr><td>Total Amount Due :" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt - Convert.ToDouble(ad))) + "</td></tr>";
                }
            ...
            if (strPreview2.Contains("Due Delivery Date"))
            { }
            else
            {
            ...
            if (PrintDueDate)
            {
                ...
                if (strPreview2.Contains("Total Pcs."))
                { }
                else
                {
            ...
            for (int i = (Convert.ToInt32(hdnId.Value)); i < checkCondition; i++)
            {
                ...
                if (isComparing)
                {
                    ItemStatus = BAL.BALFactory.Instance.BAL_New_Bookings.GetNoOfClothesReceivedForComarping(dsMain.Tables[1].Rows[i]["StatusName"].ToString(), Globals.BranchID);
                    DeliverOrUnDeliver = ItemStatus.Split('/');
                }
                if (Color != "")
                { Color = "- " + Color; }
                else
                ...
                if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() != "None" && dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() != "None")
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                        strPreview += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview2 += "<tr style='font-size:12px'><td >" + dsMain.Tables[1].Rows[i]["ISN"].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                        strPreview += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString())) + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + string.Format("{0:0.00}", float.Parse(dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString())) + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (StoreCopy)
                                    strPreview1 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + dsMain.Tables[1].Rows[i]["ISN"].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                            else
                            {
                                if (StoreCopy)
                                    strPreview1 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                        }
                    }
                }
            ...
            if (Convert.ToInt32(hdnId.Value) < 9)
            {
                if (termAndCondition)
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size: 10px'><td align='center' colspan='3' style='font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000; font-size: 25Px; color: Gray'rowspan='4'>Store Copy&nbsp;<span style='font-size: small; color: #000000;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>Subtotal</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + string.Format("{0:0.00}", wholeAmt) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview += "<tr style='font-size:10px'><td colspan='3' style='font-weight: bold; border-top-style: solid; border-top-width: thin;border-top-color: #000000'>&nbsp;Terms and Conditions (R.O.A.C) &nbsp;&nbsp;<span style='font-weight: bold; font-size: 9px;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>Subtotal</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + string.Format("{0:0.00}", wholeAmt) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                ...
                else
                {
                    ...
                    if (Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()) > 0)
                    {
                        if (Convert.ToBoolean(dsMain.Tables[0].Rows[0]["DiscountOption"]).ToString() == "False")
                        {
                            if (StoreCopy)
                                strPreview1 += "<tr style='font-size:10px'><td align='right' style='font-size:12px;font-weight:bold' nowrap='nowrap'>Dis (" + string.Format("{0:0.00}", Math.Round(Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()), 2)) + "%)</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(disWhole, 2)) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            strPreview += "<tr style='font-size:10px'><td  colspan='3'>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td><td align='right' style='font-size:12px;font-weight:bold' nowrap='nowrap'>Dis (" + string.Format("{0:0.00}", Math.Round(Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()), 2)) + "%)</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(disWhole, 2)) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        }
                        else
                        {
                            if (StoreCopy)
                    ...
                    else
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:10px'><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Ceiling(Math.Round((Convert.ToDouble(wholeAmt) + Convert.ToDouble(serviceTax)) - Convert.ToDouble(disWhole), 2))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Ceiling(Math.Round((Convert.ToDouble(wholeAmt) + Convert.ToDouble(serviceTax)) - Convert.ToDouble(disWhole), 2))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                }
                if (StoreCopy)
            ...
            else
            {
                if (hdnId.Value != dsMain.Tables[1].Rows.Count.ToString())
                {
                    if (termAndCondition)
                    {
                        ...
                        {
                            if (StoreCopy)
                                strPreview1 += "<tr style='font-size:10px'><td align='center' colspan='3' style='font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000; font-size: 25Px; color: Gray'rowspan='4'>Store Copy&nbsp; <span style='font-size: small; color: #000000;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td> <td style='font-weight: bold; border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>&nbsp;</td></tr>";
                            strPreview += "<tr style='font-size:10px'><td colspan='5' style='font-weight: bold;border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;Terms and Conditions (R.O.A.C) &nbsp;<span style='font-weight: bold; font-size: 9px;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ": " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td></tr>";
                        }
                        else
                        {
                            if (StoreCopy)
                    ...
                    else
                    {
                        ...
                        {
                            if (StoreCopy)
                                strPreview1 += "<tr style='font-size:10px;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td align='center' colspan='3' rowspan='4' style='font-size: 25px;color:Gray'>Store Copy &nbsp;&nbsp;&nbsp;&nbsp;<span style='font-size: small; color: #000000;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td><td  align='right' style='font-size:12px;font-weight:bold'></td><td align='right' style='font-size:12px;font-weight:bold'></td></tr>";
                            strPreview += "<tr style='font-size:10px;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td  colspan='3'><span style='font-size: small; color: #000000;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td><td  align='right' style='font-size:12px;font-weight:bold'></td><td align='right' style='font-size:12px;font-weight:bold'></td></tr>";
                        }
                        else
                        {
            ...
            if (BAL.BALFactory.Instance.BAL_New_Bookings.DisplayNetAmountFlatOrFolat(Globals.BranchID) == "True")
            {
                strPreview2 += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(totalWholeAmt - Convert.ToDouble(ad), 2)) + "</td></tr>";
            }
            else
            {
                strPreview2 += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt - Convert.ToDouble(ad))) + "</td></tr>";
            }            
    ...
    public string GetBookingDetailsForBookingNumberProcessRate(string BookNumber, string date)
    {
        try
        {
            ...
            bool Flag = false, BookingTime = true, logoOnReceipt = false, tableBorder = false, prePrintedOrBanner = false, barcode = false, headerBanner = false, previousDue = false, footerBanner = false, termAndCondition = false, St = false, PrintDueDate = false, PrintSubItems = false;
            string logoLeftRight = string.Empty, printBookingTime = string.Empty;
            PrintDueDate = Convert.ToBoolean(ds.Tables[0].Rows[0]["PrintDueDate"].ToString());
            prePrintedOrBanner = Convert.ToBoolean(ds.Tables[0].Rows[0]["PrePrinted"].ToString());
            headerBanner = Convert.ToBoolean(ds.Tables[0].Rows[0]["ShowHeaderSlogan"].ToString());
        ...
        START:
            if (prePrintedOrBanner)
            {
                ...
                if (logoLeftRight == "1")
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview4 += "<td style='width: 1.5in'><img alt='' src='../ReceiptLogo/DRY" + Globals.BranchID + ".jpg' width='110px' height='96px' /></td><td align='center' style='width: 5.0in;'>";

                        strPreview3 += "<td style='width: 1.5in'><img alt='' src='../ReceiptLogo/DRY" + Globals.BranchID + ".jpg' width='110px' height='96px' /></td><td align='center' style='width: 5.0in;'>";
                        if (StoreCopy)
                ...
                else
                {
                    if (logoOnReceipt)
                    {
                        ...
                        strPreview3 += "<td style='width: 1.5in'></td><td align='center' style='width: 5.0in;'><table><tr><td align='center'> <span style='font-family:" + ds.Tables[0].Rows[0]["HeaderFontName"].ToString() + ";font-size:" + ds.Tables[0].Rows[0]["HeaderFontSize"].ToString() + "px; font-weight:" + ds.Tables[0].Rows[0]["HeaderFontStyle"].ToString() + "; text-decoration:" + ds.Tables[0].Rows[0]["TextFontStyleUL"].ToString() + ";font-style:" + ds.Tables[0].Rows[0]["TextFontItalic"].ToString() + "'>" + ds.Tables[0].Rows[0]["Headertext"].ToString() + "</span></td></tr><tr><td align='center'><span style='font-family:" + ds.Tables[0].Rows[0]["AddressFontName"].ToString() + ";font-size:" + ds.Tables[0].Rows[0]["AddressFontSize"].ToString() + "px; font-weight:" + ds.Tables[0].Rows[0]["AddressFontStyle"].ToString() + ";text-decoration:" + ds.Tables[0].Rows[0]["TextAddressUL"].ToString() + ";font-style:" + ds.Tables[0].Rows[0]["TextAddressItalic"].ToString() + "'>" + ds.Tables[0].Rows[0]["AddressText"].ToString() + "</span></td></tr></table>";
                        if (StoreCopy)
                            strPreview4 += "</td><td style='width: 1.5in'><img alt='' src='../ReceiptLogo/DRY" + Globals.BranchID + ".jpg' width='110px' height='96px' /></td></tr></table></td></tr>";

                        strPreview3 += "</td><td style='width: 1.5in'><img alt='' src='../ReceiptLogo/DRY" + Globals.BranchID + ".jpg' width='110px' height='96px' /></td></tr></table></td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
            ...
            if (previousDue)
            {
                ...
                if (DeliveryDiscount != 0)
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview4 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                        strPreview3 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 2)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 2)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                            strPreview4 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                        strPreview3 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(pending, 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Previous Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>+</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(Paid), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Paid</td></tr></table></td><td align='center' style='font-weight: bolder; font-size: 30px'>-</td><td style='width: 2.0in' align='center'><table><tr><td style='font-size: 12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(DeliveryDiscount), 2)) + "</td></tr><tr><td align='center' style='font-size: 12px'>Cash Discount</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(bal, 0)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                    }
                }
                else
                {
                ...
                {
                    strPreview2 += "<tr><td>Total Amount Due :" + string.Format("{0:0.00}", Math.Round(totalWholeAmt - Convert.ToDouble(ad), 2)) + "</td></tr>";
                }
                pend = Convert.ToInt32((totalWholeAmt - Advance1)).ToString();
            }
            else
            {
                ...
                {
                    if (StoreCopy)
                        strPreview4 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(bal)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";

                    strPreview3 += "<tr style='font-size:12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tr><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr><tr><td align='center' style='font-size:12px'>Current Due</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:30px'>-</td><td style='width:2.0in' align='center'><table><tr><td style='font-size:12px'>&nbsp;&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Round(Convert.ToDecimal(ad), 0)) + "</td></tr><tr><td align='center' style='font-size:12px'>Advance</td></tr></table></td> <td align='center' style='font-weight:bolder;font-size:25px'>=</td><td style='width:2.0in' align='center'><table><tr><td align='center' style='font-weight:bold;font-size:12px'>&nbsp;" + amtFormat + "&nbsp;:&nbsp;" + string.Format("{0:0.00}", Math.Ceiling(bal)) + "</td></tr><tr><td style='font-weight:bold;font-size:12px' align='center'>Balance Due</td></tr></table></td></tr></table></td></tr>";
                }
                if (strPreview2.Contains("Total Amount Due"))
                { }
                else
            ...
            for (int i = (Convert.ToInt32(hdnId.Value)); i < checkCondition; i++)
            {
                ...
                if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() != "None" && dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() != "None")
                {
                    ...
                    {
                        if (StoreCopy)
                            strPreview4 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                        strPreview3 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                            strPreview4 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                        strPreview3 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                }
                else
                {
                    if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() != "None")
                    {
                        ...
                        {
                            if (StoreCopy)
                                strPreview4 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                            strPreview3 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        }
                        else
                        {
                            if (StoreCopy)
                                strPreview4 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                            strPreview3 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + "- " + ExProcess1 + Rate1 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        }
                    }
                    else
                    {
                        if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() != "None")
                        {
                            ...
                            {
                                if (StoreCopy)
                                    strPreview4 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview3 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                            else
                            {
                                if (StoreCopy)
                                    strPreview4 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview3 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + '-' + " " + ExProcess2 + Rate2 + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                        }
                        else
                        {
                            ...
                            {
                                if (StoreCopy)
                                    strPreview4 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview3 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                            else
                            {
                                if (StoreCopy)
                                    strPreview4 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";

                                strPreview3 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + " " + Process + Rate + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                        }
                    }
                }
            ...
            if (Convert.ToInt32(hdnId.Value) < 9)
            {
                if (termAndCondition)
                {
                    if (PrintTaxDetail)
                    {
                        ...
                        strPreview3 += "<tr style='font-size:10px'><td colspan='3' style='font-weight: bold; border-top-style: solid; border-top-width: thin;border-top-color: #000000'>&nbsp;Terms and Conditions (R.O.A.C) &nbsp;&nbsp;<span style='font-weight: bold; font-size: 9px;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>Subtotal</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + string.Format("{0:0.00}", wholeAmt) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                ...
                else
                {
                    ...
                    if (Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()) > 0)
                    {
                        if (Convert.ToBoolean(dsMain.Tables[0].Rows[0]["DiscountOption"]).ToString() == "False")
                        {
                            if (StoreCopy)
                                strPreview4 += "<tr style='font-size:10px'><td align='right' style='font-size:12px;font-weight:bold' nowrap='nowrap'>Dis (" + string.Format("{0:0.00}", Math.Round(Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()), 2)) + "%)</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(disWhole, 2)) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            strPreview3 += "<tr style='font-size:10px'><td  colspan='3'>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td><td align='right' style='font-size:12px;font-weight:bold' nowrap='nowrap'>Dis (" + string.Format("{0:0.00}", Math.Round(Convert.ToDouble(dsMain.Tables[0].Rows[0]["Discount"].ToString()), 2)) + "%)</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(disWhole, 2)) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                        }
                        else
                        {
                            if (StoreCopy)
                ...
                if (BAL.BALFactory.Instance.BAL_New_Bookings.DisplayNetAmountFlatOrFolat(Globals.BranchID) == "True")
                {
                    strPreview2 += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(totalWholeAmt, 2)) + "</td></tr>";
                }
                else
                {
                    strPreview2 += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Current Due</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Ceiling(totalWholeAmt)) + "</td></tr>";
                }
            }
            else
            {
                if (hdnId.Value != dsMain.Tables[1].Rows.Count.ToString())
                {
                    if (termAndCondition)
                    {
                        if (PrintTaxDetail)
                        {
                            if (StoreCopy)
                                strPreview4 += "<tr style='font-size:10px'><td align='center' colspan='3' style='font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000; font-size: 25Px; color: Gray'rowspan='4'>Store Copy&nbsp; <span style='font-size: small; color: #000000;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td> <td style='font-weight: bold; border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>&nbsp;</td></tr>";
                            strPreview3 += "<tr style='font-size:10px'><td colspan='5' style='font-weight: bold;border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;Terms and Conditions (R.O.A.C) &nbsp;<span style='font-weight: bold; font-size: 9px;'>Booked By : " + dsMain.Tables[0].Rows[0]["BookingAcceptedByUserId"].ToString() + "</span>&nbsp;<span style='font-weight: bold; font-size: 9px;'>( " + dsMain.Tables[7].Rows[0]["TaxName1"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["MainTax"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName2"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["Cess"].ToString()) + ", " + dsMain.Tables[7].Rows[0]["TaxName3"].ToString() + string.Format("{0:0.00}", dsMain.Tables[7].Rows[0]["HCess"].ToString()) + " = " + string.Format("{0:0.00}", Math.Round(serviceTot, 2)) + " )</span></td></tr>";
                        }
                        else
                        {
                            if (StoreCopy)
            ...
            for (int i = (Convert.ToInt32(hdnId.Value)); i < checkCondition; i++)
            {
                ...
                if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() != "None" && dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() != "None")
                {
                    if (PrintSubItems)
                    {
                        ...
                        strPreview += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";
                        strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + dsMain.Tables[1].Rows[i]["ItemExtraProcessRate1"].ToString() + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + dsMain.Tables[1].Rows[i]["ItemExtraProcessRate2"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString())) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                    }
                    else
                    {
                        if (StoreCopy)
                            strPreview1 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (StoreCopy)
                                    strPreview1 += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";

                                strPreview += "<tr style='font-size:12px'><td >" + DeliverOrUnDeliver[1].ToString() + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString())) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                            else
                            {
                                if (StoreCopy)
                                    strPreview1 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";

                                strPreview += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'></td></tr>";
                                strPreview2 += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + dsMain.Tables[1].Rows[i]["ItemTotalQuantity"].ToString() + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + rate2[1].ToString() + " " + Color + " " + Remarks + "</td><td align='right'></td><td align='right'>" + (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString())) + "&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>";
                            }
                        }
                    }
                }
    ...
    public string GetBookingDetailsForBookingNumberHideAmount(string BookNumber, string date, bool isComparing = false)
    {
        try
        {
            SqlCommand cmd = new SqlCommand();
        ...
        START:
            ...
            // forth section
            strPreview1 += "<tr style='font-size: 12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tbody></tbody></table></td></tr>";
            strPreview += "<tr style='font-size: 12px'><td colspan='4'><table style='width:7.9in;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000;border-top-style: solid; border-top-width: thin;border-top-color: #000000'><tbody></tbody></table></td></tr>";
