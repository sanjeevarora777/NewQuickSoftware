<%@ Page Language="C#" AutoEventWireup="true" Inherits="Laser_BookingSlip" CodeBehind="BookingSlip.aspx.cs" %>
...
<head runat="server" id="Head1">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('table[style="width:7.9in;border: thin solid #000000"]').attr('style', 'width:7.9in;border: thin solid #000000;  page-break-after: always;');
            $('table[style="width:7.9in;"]').attr('style', 'width:7.9in;page-break-after: always;');
            $('table[style="width:7.9in"]').attr('style', 'width:7.9in;page-break-after: always;');
