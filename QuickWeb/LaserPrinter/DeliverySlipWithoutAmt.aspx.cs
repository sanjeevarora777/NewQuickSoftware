...
{
    public partial class DeliverySlipWithoutAmt : System.Web.UI.Page
    {
        ...
        public string GetBookingDetailsForBookingNumber(string BookNumber, string amount, string date)
        {
            try
            {
                ...
                if (BookingTime)
                {
                    printBookingTime = dsMain.Tables[10].Rows[0]["BookingTime"].ToString();
                }
                else
                {
                    printBookingTime = "";
            ...
            START:
                ...
                {
                    if (StoreCopy)
                        strPreview1 += "<td nowrap='nowrap'  align='center' style='font-family:" + ds.Tables[0].Rows[0]["NDFName"].ToString() + ";font-size:" + ds.Tables[0].Rows[0]["NDFSize"].ToString() + "px; font-weight:" + ds.Tables[0].Rows[0]["NDB"].ToString() + ";text-decoration:" + ds.Tables[0].Rows[0]["NDU"].ToString() + ";font-style:" + ds.Tables[0].Rows[0]["NDI"].ToString() + "' >" + dsMain.Tables[1].Rows[0]["BookingNumber"].ToString() + "</td><td style='width:1.0in'><table><tr><td align='Center' style='width:1.0in;font-size:14PX;font-weight:bold;'>" + dsMain.Tables[10].Rows[0]["Bookingdate"].ToString() + "</td><td  align='center' style='font-size:13px;font-weight:bold'></td></tr><tr><td nowrap='nowrap' align='center' style='font-family: Bauhaus 93; font-size: 14px; font-weight: Bold; text-decoration: ; font-style: '>" + dsMain.Tables[0].Rows[0]["HomeDelivery"].ToString() + "" + dsMain.Tables[0].Rows[0]["Urgent"].ToString() + " " + printBookingTime + "</td></tr></table></td>";
                ...
                if (previousDue)
                {
                    if (Convert.ToInt32(hdnId.Value) < 17)
                    {
                        balance = 0;
                        try
                        {
                ...
                // Fifth Section
                strPreview += "<tr><td colspan='4' align='center'><table style='width: 7.9in; border-top-style: solid; border-top-width: thin; border-top-color: #000000;'><tr><td align='center' style='font-family: Agency FB; font-size: 14px; font-weight: ; text-decoration: ; font-style: '></td></tr></table></td></tr>";
                ...
                if (PrintSubItems)
                {
                    strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width: 7.9in;'><tr><td style='width:0.5in;font-weight: bold;font-size:14px'>S.No</td><td style='width:0.5in;font-weight: bold;font-size:14px'>Pcs</td><td style='width:4.25in;font-weight: bold;font-size:14px' align='left'>Particular's</td><td style='width:.75in;font-weight: bold;font-size:14px' align='center'></td><td style='width:2.0in;font-weight: bold;font-size:14px' align='center'>Delivered Pcs</td></tr>";
                }
                else
                {
                    strPreview += "<tr style='font-size:12px'><td colspan='4'><table style='width: 7.9in;'><tr><td style='width:0.5in;font-weight: bold;font-size:14px'></td><td style='width:0.5in;font-weight: bold;font-size:14px'>Pcs</td><td style='width:4.25in;font-weight: bold;font-size:14px' align='left'>Particular's</td><td style='width:1.75in;font-weight: bold;font-size:14px' align='center'>Status</td><td style='width:1.0in;font-weight: bold;font-size:14px' align='right'>Amount</td></tr>";
                }
                ...
                if (Convert.ToInt32(hdnId.Value) < 15)
                    checkCondition = (dsMain.Tables[1].Rows.Count > 15 ? 15 : dsMain.Tables[1].Rows.Count);
                else
                {
                ...
                for (int i = (Convert.ToInt32(hdnId.Value)); i < checkCondition; i++)
                {
                    ...
                    if (dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() != "None" && dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() != "None")
                    {
                        if (PrintSubItems)
                        {
                            strPreview += "<tr style='font-size:12px'><td >" + incRow + "</td><td >" + DeliverOrUnDeliver[1] + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + Color + " " + Remarks + " " + "</td><td align='center'></td><td align='center'>" + DeliverOrUnDeliver[0] + "</td></tr>";
                        }
                        else
                        {
                            strPreview += "<tr style='font-size:12px'><td >" + "" + "</td><td >" + DeliverOrUnDeliver[1] + "</td><td>" + "<span style='font-family:Arial Black; font-size: 11px;'>" + dsMain.Tables[1].Rows[i]["ItemName"].ToString() + "</span>" + " " + dsMain.Tables[1].Rows[i]["ItemProcessType"].ToString() + "@" + Rate + " " + "- " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType1"].ToString() + '@' + Rate1 + " " + '-' + " " + dsMain.Tables[1].Rows[i]["ItemExtraProcessType2"].ToString() + '@' + Rate2 + " " + Color + " " + Remarks + " " + DeliverOrUnDeliver[2].ToString() + "</td><td align='center'>" + ClothesStatus + "</td><td align='right'>" + string.Format("{0:0.00}", (Convert.ToDouble(dsMain.Tables[1].Rows[i]["ItemSubTotal"].ToString()))) + "</td></tr>";
                        }
                    }
                    else
                    {
                ...
                if (Convert.ToInt32(hdnId.Value) < 15)
                {
                    ...
                    else
                    {
                        ...
                        if (PrintTaxDetail)
                            strPreview += "<tr style='font-size:10px'><td colspan='3' style='font-size: 12px; font-weight: bold; border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + dsMain.Tables[0].Rows[0]["TotalQty"].ToString() + "</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000' nowrap='nowrap'>Total Pcs Delivered</td><td align='center' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + dsMain.Tables[9].Rows[0]["DeliveredQty"].ToString() + "</td></tr>";
                        else
                            strPreview += "<tr style='font-size:10px'><td colspan='3' style='font-size: 12px; font-weight: bold; border-top-style: solid; border-top-width: thin; border-top-color: #000000'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " + dsMain.Tables[0].Rows[0]["TotalQty"].ToString() + "</td><td align='right' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000' nowrap='nowrap'>Total Pcs Delivered</td><td align='center' style='font-size: 12px; font-weight: bold; font-weight: bold; border-top-style: solid;border-top-width: thin; border-top-color: #000000'>" + dsMain.Tables[9].Rows[0]["DeliveredQty"].ToString() + "</td></tr>";
                        ...
                        //}
                         strPreview += "<tr style='font-size: 10px; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td colspan='3'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold' nowrap='nowrap'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold'>&nbsp;</td></tr><tr style='font-size: 10px; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td colspan='3'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold' nowrap='nowrap'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold'>&nbsp;</td></tr>";
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            strPreview += "<tr style='font-size:10px;border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td colspan='3'>&nbsp;</td><td  align='right' style='font-size:12px;font-weight:bold' nowrap='nowrap'>Total Pcs Delivered</td><td align='center' style='font-size:12px;font-weight:bold'>" + dsMain.Tables[9].Rows[0]["DeliveredQty"].ToString() + "</td></tr>";
                            strPreview += "<tr style='font-size: 10px; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td colspan='3'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold' nowrap='nowrap'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold'>&nbsp;</td></tr><tr style='font-size: 10px; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #000000'><td colspan='3'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold' nowrap='nowrap'>&nbsp;</td><td align='right' style='font-size: 12px; font-weight: bold'>&nbsp;</td></tr>";
                            //if (St)
                            //{
                            //    strPreview += "<tr style='font-size:10px'><td  colspan='3'></td><td align='right' style='font-size:12px;font-weight:bold'>Tax</td><td align='right' style='font-size:12px;font-weight:bold'>" + string.Format("{0:0.00}", Math.Round(serviceTax, 2)) + "</td></tr>";
