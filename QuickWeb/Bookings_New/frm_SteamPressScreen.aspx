<%@ Page Title="" Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true" CodeBehind="frm_SteamPressScreen.aspx.cs" Inherits="QuickWeb.Bookings_New.frm_SteamPressScreen"  EnableEventValidation="false" ValidateRequest="false" %>
...
//                }
			...
			function SaveRemoveChallanDetail() {
				...
				$.ajax({
					...
					data: "{retText: '" + $('#hdnRmvReason').val() + "', DataToRemove: '" + $('#hdnRmvReasonData').val() + "', flag: '" + screenFlag + "',ScreenName:3}",
					type: 'POST',
					timeout: 20000,
					contentType: 'application/json; charset=UTF-8',
					datatype: 'JSON',
   ...
   <div class="panel panel-primary well-sm-tiny1">
		<div class="panel-heading">
			<h3 class="panel-title">
				<span class="textBold">Cloth Ready - </span>Cloth Ready Mark all cloths that are ready to be delivered
		...
		<div class="panel-body well-sm-tiny">
			<div class="row-fluid">
				...
				<div>
					<asp:Button ID="btnSms" runat="server" Text="Send Sms" EnableTheming="false" Visible="false" CssClass="btn btn-primary"
						 ClientIDMode="Static" />
				</div>
			</div>
			<div class="row-fluid">
