<%@ Page Title="" Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true" CodeBehind="frmNewChallan.aspx.cs" Inherits="QuickWeb.Booking_New.frmNewChallan" EnableEventValidation="false" ValidateRequest="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	        ...
	        */
	        ...
	        $('#chkRemove').click(function (e) {
	            if ($(this).is(':checked')) {
	                ...
	                $('#txtBarcode').attr('disabled', true);
	                $('#chkPrintChallan').attr('disabled', false);
	                $('#chkPrintSticker').attr('disabled', false);
	                $('#txtBarcode').focus();
	        ...
	        function SaveRemoveChallanDetail() {
	            ...
	            $.ajax({
	                ...
	                data: "{retText: '" + $('#hdnRmvReason').val() + "', DataToRemove: '" + $('#hdnRmvReasonData').val() + "', flag: '" + screenFlag + "',ScreenName:1}",
	                type: 'POST',
	                timeout: 20000,
	                contentType: 'application/json; charset=UTF-8',
	                datatype: 'JSON',
	...
	<script type="text/javascript">
	    $(document).ready(function (event) {
	        ...
	        $('#ctl00_ContentPlaceHolder1_txtCustomerName').change(function (e) {
	        ...
	        $('#btnSaveChallan, #btnPrint ,#ctl00_ContentPlaceHolder1_btnStickKerPrint').click(function (e) {
	            ...
	            if ($('#ctl00_ContentPlaceHolder1_drpMulti').is(':visible') && $('#ctl00_ContentPlaceHolder1_drpMulti').val() == 'Select Workshop') {
...
<h3 class="panel-title"><span class="textBold">Send to Workshop - </span> Create Workshop Note for all the cloths you need to send to workshop for processing
...
<div  class="row-fluid">
<div class="col-sm-2">
<asp:TextBox ID="txtBarcode" runat="server" OnTextChanged="txtBarcode_TextChanged" autocomplete="off" CssClass="form-control" placeholder="Order / Barcode No"
ClientIDMode="Static" MaxLength="20" EnableTheming="false"></asp:TextBox>
    <cc1:FilteredTextBoxExtender ID="txtBarcode_FilteredTextBoxExtender" 
        runat="server" Enabled="True"  ValidChars="1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-"  TargetControlID="txtBarcode">
   ...
   <asp:DropDownList ID="drpProcess" runat="server"  AppendDataBoundItems="true"  CssClass="form-control">
	...
	<div  class="col-sm-4">
	 <asp:TextBox ID="txtCustomerName" runat="server" onfocus="javascript:select();"  CssClass="form-control"
					placeholder="Filter clothes of a Customer"	 Visible="true" ></asp:TextBox>
	...
	<div class="col-sm-2 form-inline nopadding">     
		...
		<asp:TextBox ID="txtHolidayDate" runat="server" MaxLength="11" onkeypress="return false;" CssClass="form-control" EnableTheming="false"
				placeholder="Due Date"	ToolTip="Double Click To Clear The Date" onpaste="return false;"></asp:TextBox>
		...
		<div  class="form-group">
		<asp:Button ID="btnClearDate" ClientIDMode="Static" runat="server" Text="X" CssClass="btn btn-primary btn-block"  EnableTheming="false" Width="20px"/>
		</div>       
		 <div  class="form-group" style="display:none">
	<asp:Button ID="btnRefresh" runat="server" Text="Refresh" OnClick="btnRefresh_Click" CssClass="btn btn-primary" EnableTheming="false" />  
	</div>

	  </div>
	   <div class="col-sm-2">  
	<asp:Button ID="bntPrintPrv" runat="server" Text="View all Workshop Notes" OnClick="btnPrintPrv_Click"  EnableTheming="false"
	...
	<div  class="row-fluid">
	  ...
	  <div class="col-sm-4 form-inline">
		...
		<div  class="form-group">
		<asp:TextBox ID="txtRemoverChallan" runat="server" Width="190px" MaxLength="250" CssClass="form-control"  disabled="Disabled"
		...
		<div  class="form-group">
		<asp:Button ID="btnSaveRemoveChallan" runat="server"  CssClass="btn btn-danger" disabled="Disabled"
		 EnableTheming="false"   ClientIDMode="Static" Text="Return" />
		</div>
	</div>
	...
	<asp:CheckBox ID="chkPrintChallan" runat="server" Text="&nbsp;Print Workshop Note" ClientIDMode="Static" />
	  ...
	  <div class="col-sm-2 ">
	   ...
	   <asp:Label ID="lblSent" runat="server" Text="Workshop :"></asp:Label>
		...
		<asp:DropDownList ID="drpMulti" runat="server" AppendDataBoundItems="true"  CssClass="form-control">
					</asp:DropDownList>     
	   
		</div>
		 <div class="col-sm-2">
	  <%--  <asp:Button ID="btnPrint" runat="server" Text="Send to Workshop & Print" CssClass="disabledClass btn btn-primary btn-block"
						 EnableTheming="false" ClientIDMode="Static" />--%>
						  <a class="disabledClass btn btn-primary btn-block" id="btnPrint" runat="server" clientidmode="static">
		<i class="fa fa-print icon-white" ></i>&nbsp;Send & Print</a>  
		</div>
		<div class="col-sm-1">
   <%--  <asp:Button ID="btnSaveChallan" runat="server" Text="Send to Workshop" CssClass="disabledClass btn btn-primary btn-block"
						 EnableTheming="false" ClientIDMode="Static" />--%>
				<a class="disabledClass btn btn-primary btn-block" id="btnSaveChallan" runat="server" clientidmode="static">
		<i class="fa fa-arrow-circle-o-right	icon-white" ></i>&nbsp;Send</a>  
   ...
   <div class="span1  well well-sm-tiny" id="DivLeftContainer">
		<div id="DivLeftCounter" class="span label label-default">
		   <h4> <asp:Label runat="server" ID="lblLeft" Text="" ClientIDMode="Static"></asp:Label></h4>
		</div>
	</div>

	<div  id="DivContainerStatus" class="span10  well well-sm-tiny">
		<div id="DivContainerInnerStatus"  class="span label label-default"> 
		<h4 class="textmargin"><asp:Label ID="lblErr" runat="server" EnableViewState="False" Font-Bold="True" CssClass="ErrorMessage"  ClientIDMode="Static"/>
		<span style="margin-left:40%"><asp:Label ID="lblMsg" runat="server" EnableViewState="False" Font-Bold="True"    ClientIDMode="Static" ForeColor="White" /></span>
			<span style ="margin-left:-20%"><asp:Label ID="lblStatusCloth" runat="server" ClientIDMode="Static" EnableTheming="false"></asp:Label> &nbsp;</span></h4>
		</div>
	</div>  
	...
	<div id="DivRightContainer" class="span1  well well-sm-tiny" style="margin-left:23px">
		<div id="DivRightCounter" class="span label label-default">
			<h4><asp:Label ID="lblQtyCount" runat="server" Text="" ClientIDMode="Static"></asp:Label></h4>
		</div>
	</div>
	</div>
	...
	<div class="row-fluid form-signin4 no-bottom-margin">
			...
			<div class="span1 well well-sm  gridhight-noscroll no-bottom-margin">
				...
				<div class="div-margin">
				  <asp:Button ID="btnMoveRight" runat="server" Text="  >  " ClientIDMode="Static" CssClass="btn btn-info btn-sm btn-block" EnableTheming="false" Font-Bold="True" Font-Size="Large" />                
				</div>
				<div class="div-margin">                 
				   <asp:Button ID="btnMoveLeft" runat="server" Text="  <  " ClientIDMode="Static" CssClass="btn btn-info btn-sm btn-block" EnableTheming="false" Font-Bold="True" Font-Size="Large" />
				</div>
				<div class="space">
				</div>
				<div >
				...
				<div class="div-margin">                 
					<asp:Button ID="btnMoveRightAll" runat="server" Text=">>" ClientIDMode="Static" CssClass="btn btn-info btn-sm btn-block" EnableTheming="false" Font-Bold="True" Font-Size="Large" />
				</div>
				<div class="div-margin">                  
					<asp:Button ID="btnMoveLeftAll" runat="server" Text="<<" ClientIDMode="Static" CssClass="btn btn-info btn-sm btn-block" EnableTheming="false" Font-Bold="True" Font-Size="Large"/>
				</div>
				<div>
				<asp:Button ID="btnDeleteAll" runat="server" Text="   X  " ClientIDMode="Static" CssClass="btn btn-info btn-sm btn-block" EnableTheming="false" Font-Bold="True" Font-Size="Large"
						Style="display: none;" />
				</div>
				<div class="spacer">
				</div>
			...
			<div class="span5 well well-sm no-bottom-margin">
				<div class="DivStyleWithScroll" style="overflow: scroll; height: 400px;">
						<asp:GridView ID="grdSelectedCloth" runat="server" EmptyDataText="There are no pending cloth to be send to workshop" CssClass="mgrid" AutoGenerateColumns="False"
							ShowFooter="False" OnRowDataBound="grdSelectedCloth_RowDataBound" EnableTheming="false" >
							<Columns>
								<asp:TemplateField>
									<HeaderTemplate>
	...
	<asp:Panel ID="pnlPanel" runat="server" CssClass="" Style="display: none;margin-left:0px"
