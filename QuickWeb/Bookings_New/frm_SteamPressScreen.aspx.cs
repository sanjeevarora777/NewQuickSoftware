...
{
    public partial class frm_SteamPressScreen : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (AppClass.CheckButtonRights(SpecialAccessRightName.MarkForDelMoveAll) == true)
            {
        ...
        {           
            ...
            grdNewChallan.DataSource = BAL.BALFactory.Instance.BAL_ChallanIn.GetDataSteamPressScreen(Globals.BranchID, txtBarcode.Text, txtHolidayDate.Text, drpValue); 
        ...
        private void BindRightGrid()
        {
            ...
            dsNew = BAL.BALFactory.Instance.BAL_ChallanIn.BindRightGrid(Globals.BranchID, 50, Globals.UserName);
