<%@ Page Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true" Inherits="Reports_MainDeliveryReport" Title="Untitled Page" Codebehind="MainDeliveryReport.aspx.cs" %>
                        ...
                        <tr>
                            <td>
                                <table class="TableData" width="100%">
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" class="TDCaption" style="text-align: left" width="50%">
                                            <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                                                <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" DataKeyNames="BookingNo"
                                                    CssClass="mGrid" ShowFooter="True" EmptyDataText="No Records found" PageSize="50"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="BalanceQty" HeaderText="Balance Qty" SortExpression="BalanceQty" />
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgBtnShowDetails" runat="server" ImageUrl="~/images/ZoomHS.png"
                                                                    CommandArgument='<%# Bind("BookingNo") %>' CommandName="CMDShowDetails" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                        ...
                                        <td nowrap="nowrap" runat="server" class="TDCaption" style="text-align: left" width="50%">
                                            <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                                                <asp:GridView ID="grdStockDetails" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                                                    Caption="Details" CssClass="mGrid">
                                                    <Columns>
                                                       <%-- <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="hypBtnShowDetails0" runat="server" Text='<%# Bind("BookingNo") %>'
                                                                    Target="_blank" NavigateUrl='<%# String.Format("~/Bookings/BookingSlip.aspx?BN={0}",Eval("BookingNo")) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                         <asp:BoundField DataField="BookingNo" HeaderText="Booking Number" />
