...
{
    public partial class FQDR : System.Web.UI.Page
    {
        ...
        public void ShowPackageQtyDetail(string AID, string CustCode)
        {
            ...
            dsMain = BAL.BALFactory.Instance.Bal_Processmaster.FlatPackageQty(Globals.BranchID, AID, CustCode);
            string res = BAL.BALFactory.Instance.BAL_RemoveReason.GetDateTime(Globals.BranchID);
            if (dsMain.Tables[0].Rows.Count > 0)
            {
                ReportViewer1.LocalReport.ReportPath = "RDLC/FQDR.rdlc";
