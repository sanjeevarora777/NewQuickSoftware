...
{
    public partial class VBRD : System.Web.UI.Page
    {
        ...
        public void ShowPackageQtyDetail(string AID, string CustCode)
        {
            ...
            dsMain = BAL.BALFactory.Instance.Bal_Processmaster.ValuBenifitPackageDtl(Globals.BranchID, AID, CustCode);
            string res = BAL.BALFactory.Instance.BAL_RemoveReason.GetDateTime(Globals.BranchID);
            if (dsMain.Tables[0].Rows.Count > 0)
            {
                ReportViewer1.LocalReport.ReportPath = "RDLC/VBRD.rdlc";
