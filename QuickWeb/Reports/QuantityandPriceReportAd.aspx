<%@ Page Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    Inherits="QuantityandPriceReportAd" Title="Untitled Page" CodeBehind="QuantityandPriceReportAd.aspx.cs" %>
        ...
        <table class="TableData" width="100%">
                                    ...
                                    <tr>
                                        <td nowrap="nowrap">
                                            ...
                                            <asp:CheckBox ID="chkInvoice" runat="server" Text="Search By Invoice No." AutoPostBack="True"
                                                OnCheckedChanged="chkInvoice_CheckedChanged" ClientIDMode="Static" />
            ...
            <tr>
                <td class="TDCaption" style="text-align: left">
                    ...
                    <div class="DivStyleWithScroll" style="width: 1224Px; overflow: scroll; height: 250px;">
                        <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" DataKeyNames="BookingNumber" OnDataBound="grdReportDataBound" 
            ...
            <tr>
                <td>
                    ...
                    &nbsp; &nbsp;
                    <asp:Button ID="btnPrint" runat="server" Text="Print Order Tickets" Visible="true" OnClick="btnPrint_Click" />
                    &nbsp; &nbsp;
                    <asp:Button ID="btnPrintStore" runat="server" Text="Print Store Copy" Visible="true" OnClick="btnPrintStore_Click" />
                    &nbsp; &nbsp;
