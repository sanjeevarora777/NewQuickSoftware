<%@ Page Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true" Inherits="Reports_DeliveryBill" Title="Untitled Page" Codebehind="DeliveryBill.aspx.cs" %>
                                ...
                                <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                                    <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" DataKeyNames="BookingNumber"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NetAmount" HeaderText="Total Cost" ItemStyle-HorizontalAlign="Right"
                                            ...
                                            <asp:BoundField DataField="DuePayment" HeaderText="Due" ItemStyle-HorizontalAlign="Right"
