<%@ Page Title="" Language="C#" MasterPageFile="~/StoreMain.Master" AutoEventWireup="true"
    CodeBehind="frmBoundToMachine.aspx.cs" Inherits="QuickWeb.New_Admin.frmBoundToMachine" %>
                    ...
                    <div class="row-fluid" style="text-align: justify;">
                        ...
                        <div>
                            <ol style="margin-left: 20px">
                                <li>Kindly make sure you have configured email and mobile no in store configuration,
                                    click<a class="link2" href="../Masters/BranchMaster.aspx"> here to Verify / Change</a> store
                                        details. </li>
            ...
            $('#rdrBoundToMachine').click(function (e) {
                ...
                if ($('#rdrBoundToMachine').is(':checked')) {
                    ...
                    if ((mobile == '') || (EmalID == '')) {
                        ...
                        $('#lblMsg').text('Kindly make sure you have configured email and mobile no in store configuration');
                        return false;
                    }
