...
namespace QuickWeb.Config_Setting
{
    ...
    public partial class frmDailySummaryConfig : System.Web.UI.Page
    {
        ...
        protected void btnSendStatus_Click(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    if (rdbBookingReportTrue.Checked)
                    {
                        CreateBookingPDF(Ob);                     
                ...
                case 2:
                    ...
                    goto case 3;
                case 3:
                    if (rdbDeliveryReportTrue.Checked)
                    {
                ...
                case 5:
                    ...
                    goto case 6;
                case 6:
                    if (rdbDetailCashBookReportTrue.Checked)
                    {                       
        ...
        private void SetTrueRadioButton(bool status)
        {
            rdbBookingReportTrue.Checked = status;
            rdbSalesReportTrue.Checked = status;
            rdbDeliveryReportTrue.Checked = status;
            rdbPaymentTypeReportTrue.Checked =status;
            rdbabcTrue.Checked = status;
            rdbDetailCashBookReportTrue.Checked = status;
        }
