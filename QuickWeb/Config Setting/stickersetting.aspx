<%@ Page Title="" Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    CodeBehind="stickersetting.aspx.cs" Inherits="QuickWeb.Config_Setting.stickersetting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkName() {
            ...
            if (document.getElementById("<%=drpbarcodeposition.ClientID %>").value == 8) {
                alert("Barcode position can not be blank");
                document.getElementById("<%=drpbarcodeposition.ClientID %>").focus();
                return false;
            }
            if (document.getElementById("<%= Drpbookinfposition.ClientID %>").value == 8) {
                alert("Booking position can not be blank");
                document.getElementById("<%= Drpbookinfposition.ClientID %>").focus();
                return false;
            }
            if (document.getElementById("<%= Drpcusposition.ClientID %>").value == 8) {
                alert("Customer position can not be blank");
                document.getElementById("<%= Drpcusposition.ClientID %>").focus();
                return false;
            }
            if (document.getElementById("<%= Drpprocessposition.ClientID %>").value == 8) {
                alert("process position can not be blank");
                document.getElementById("<%=Drpprocessposition.ClientID %>").focus();
                return false;
            }

            if (document.getElementById("<%= drpremarkposition.ClientID %>").value == 8) {
                alert("Remark position can not be blank");
                document.getElementById("<%=drpremarkposition.ClientID %>").focus();
                return false;
            }
            ...
            if (document.getElementById("<%= Drpitemposition.ClientID %>").value == 8) {
                alert("Item position can not be blank");
                document.getElementById("<%=Drpitemposition.ClientID %>").focus();
                return false;
            }
            if (document.getElementById("<%= drpaddressposition.ClientID %>").value == 8) {
                alert("Address position can not be blank");
                document.getElementById("<%=drpaddressposition.ClientID %>").focus();
                return false;
            }
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="mainContainer" align="center" style="border-style: outset">
        <div id="Div1" align="center" style="border-style: outset">
            <fieldset class="Fieldset">
                <legend class="Legend">Sticker Setting</legend>
                <div id="leftContainer" class="leftContainer">
                    <asp:Panel ID="panelwidth" runat="server">
                        <div id="widthid" runat="server">
                            <div class="barcode1">
                                Width
                            </div>
                            <div class="barcode">
                    ...
                    <asp:Panel ID="barcodepanel" runat="server" Visible="false">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode11" id="barcodeyesid" runat="server">
                            ...
                            <div class="barcode12" id="barcodeid" runat="server">
                                <asp:DropDownList ID="drpbarcodeposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="drpbarcodeposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode12">
                            </div>
                            <div class="barcode12" id="barcodealignid" runat="server">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode16">
                                <div class="barcode16" id="bookingyesid" runat="server">
                            ...
                            <div class="barcode17" id="bookingid" runat="server">
                                <asp:DropDownList ID="Drpbookinfposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="Drpbookinfposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode17" id="customerid" runat="server">
                                <asp:DropDownList ID="Drpcusposition" runat="server" Width="70px" AutoPostBack="true"
                                    OnSelectedIndexChanged="Drpcusposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                        ...
                        <div class="booking50" id="addressid" runat="server">
                            <div class="barcode15">
                                Address
                            </div>
                            <div class="barcode16">
                            ...
                            <div class="barcode17">
                                <asp:DropDownList ID="drpaddressposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="drpaddressposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode17" id="processid" runat="server">
                                <asp:DropDownList ID="Drpprocessposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="Drpprocessposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode17" id="remarkid" runat="server">
                                <asp:DropDownList ID="drpremarkposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="drpremarkposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                        ...
                        <div class="booking50">
                            ...
                            <div class="barcode22">
                                <asp:RadioButton ID="RadioItemyes" runat="server" GroupName="Item" Text=" Yes" Checked="True" />
                                <asp:RadioButton ID="RadioItemno" runat="server" GroupName="Item" Text=" No" /><br />
                            ...
                            <div class="barcode17" id="itemid" runat="server">
                                <asp:DropDownList ID="Drpitemposition" runat="server" Width="70px" AutoPostBack="True"
                                    OnSelectedIndexChanged="Drpitemposition_SelectedIndexChanged">
                                    <asp:ListItem Value="8">Select</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="barcode18">
                            ...
                            <div class="booking50" id="dividerid" runat="server">
                                <div class="barcode15">
                                    Divider
                                </div>
                                <div class="barcode16">
                                    <asp:RadioButton ID="Radiodivideryes" runat="server" GroupName="Divider" Text=" Yes"
                                        Checked="True" />
                                    <asp:RadioButton ID="Radiodividerno" runat="server" GroupName="divider" Text=" No" />
                                </div>
                                <div class="barcode17">
                                </div>
                                <div class="barcode18">
                ...
                <div class="rightContainer">
                    ...
                    <asp:Panel ID="barcodepaneldisplay" runat="server">
                        ...
                        <div class="barcodeprint">
                            <span style="width: 20%; color: #00649e;">New Sticker </span>
                    ...
                    <div class="barcodeprint">
                        <span style="width: 20%; color: #00649e;">Old Sticker</span>
