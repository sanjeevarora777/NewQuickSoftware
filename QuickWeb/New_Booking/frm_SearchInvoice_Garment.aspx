<%@ Page Title="" Language="C#" MasterPageFile="~/StoreMain.Master" AutoEventWireup="true" CodeBehind="frm_SearchInvoice_Garment.aspx.cs" Inherits="QuickWeb.New_Booking.frm_SearchInvoice_Garment" EnableEventValidation="false" ValidateRequest="false" %> 
		...
		<asp:HiddenField ID="hdnDeliveryQty" runat="server" ClientIDMode="Static" />
							...
							<Columns>
								<asp:BoundField DataField="SubItemName" HeaderText="Garment" ReadOnly="True" SortExpression="SubItemName">
								  ...
								  <asp:TemplateField HeaderText="Services">
									...
									SortExpression="Barcode"></asp:BoundField>
		  ...
		  <div class="panel panel-info well-sm-tiny1">
			...
			<div class="panel-heading">Order Details of <span class="textBold fa-lg" >&nbsp;#&nbsp;<%=_OrderNo %></span> 
             &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblWorkShopName" runat="server"  clientidmode="Static" CssClass="textBold fa-lg"  EnableTheming="false"></asp:Label>
            </div>
