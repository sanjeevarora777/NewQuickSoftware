<%@ Page Title="" Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    CodeBehind="CityMaster.aspx.cs" Inherits="QuickWeb.Masters.CityMaster" %>
    ...
    <fieldset class="Fieldset">
        <table width="100%">
            <tr>
                ...
                <td class="H1" style="font-weight: bolder">
                    <asp:Label ID="Label1" runat="server" Text="DrySoft " ForeColor="#FF9933"></asp:Label>City
                    Creation
                </td>
            </tr>
            <tr>
        ...
        <table class="TableData">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCity" runat="server" MaxLength="100" CssClass="Textbox" />
                    ...
                    <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                        <asp:GridView ID="grdSearchResult" runat="server" AutoGenerateColumns="False" EmptyDataText="There are no data records to display."
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CityID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
            ...
            <%--<tr>
                <td align="left">
                    <asp:SqlDataSource ID="SqlGridSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [CityID], [City] FROM [CityMaster] WHERE City LIKE @CityLike">
                        <SelectParameters>
                            <asp:Parameter Name="CityLike" DefaultValue="%" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>--%>
