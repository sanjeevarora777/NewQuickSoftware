<%@ Page Language="C#" MasterPageFile="~/StoreMain.master" AutoEventWireup="true"
    Inherits="RemarkMaster" Title="Remark Master" CodeBehind="RemarkMaster.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">   
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkName() {
            ...
            if (strname == "" || strname.length == 0) {
                ...
                $('#lblMsg').text("Kindly enter description.");
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function (e) {
            $("#RemarkInfo").tooltip({
                title: 'This will be used for descriptions, remarks or defects while creating invoice.',
                html: true
            });
        });
    </script>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        Descriptions/ Remarks/ Defects</h3>
                </div>
                        ...
                        <div class="col-sm-10 Textpadding">
                            <div class="col-sm-10 Textpadding">
                                <div class="input-group input-sm Textpadding">
                                    <span class="input-group-addon IconBkColor">Description</span>
                                    <asp:TextBox ID="txtJobType" runat="server" MaxLength="100" CssClass="form-control"
                                        placeholder="Kindly enter Description/ Remarks/ Defects." />
                            ...
                            <div class="col-sm-1 Textpadding form-inline">
                                ...
                                <div class="form-group" style="margin-top: -9px">
                                    &nbsp;<i id="RemarkInfo" data-placement="right" class="fa fa fa-info-circle fa-lg txtColor"></i>
                                </div>
                            </div>
                        </div>
                    </div>
