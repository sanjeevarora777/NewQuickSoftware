<%@ Page Title="" Language="C#" MasterPageFile="~/DryMasterMain.master" AutoEventWireup="true"
    CodeBehind="ProfessionMaster.aspx.cs" Inherits="QuickWeb.ProfessionMaster" %>
    ...
    <fieldset class="Fieldset">
        <table width="100%">
            <tr>
                ...
                <td class="H1" style="font-weight: bolder">
                    <asp:Label ID="Label1" runat="server" Text="DrySoft " ForeColor="#FF9933"></asp:Label>Profession
                    Creation
                </td>
            </tr>
            <tr>
        ...
        <table class="TableData">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtProfession" runat="server" MaxLength="100" CssClass="Textbox" />
        ...
        <table width="100%">
            ...
            <tr>
                <td align="center" colspan="2">
                    ...
                    <asp:Label ID="lblProfession" runat="server" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 7px">
                    ...
                    <div class="DivStyleWithScroll" style="width: 100%; overflow: scroll; height: 250px;">
                        <asp:GridView ID="grdSearchResult" runat="server" AutoGenerateColumns="False" EmptyDataText="There are no data records to display."
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ProfessionID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                                    SortExpression="ProfessionID" />
                                <asp:BoundField DataField="Profession" HeaderText="Profession" ReadOnly="True" SortExpression="Profession" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </td>
            ...
            <%--<tr>
                <td align="left">
                    <asp:SqlDataSource ID="SqlGridSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [ProfessionID], [Profession] FROM [ProfessionMaster] WHERE Profession LIKE @ProfessionLike">
                        <SelectParameters>
                            <asp:Parameter Name="ProfessionLike" DefaultValue="%" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>--%>
